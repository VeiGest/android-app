...
Registra um novo utilizador no sistema. Endpoint público para auto-registo.
...
```json
{
  ...
  "data": {
    "user": {
      ...
      "tipo": "driver",
      "company_id": 1,
      "created_at": "2026-01-11 15:30:00"
    }
  }
}
```
...
**Erros:**
- `400 Bad Request`: Dados obrigatórios em falta ou inválidos
- `422 Unprocessable Entity`: Email ou username já existe
